...
class EptfacultyController extends Controller
{
    ...
    public function index(Request $req){
        ...
        $page ='eptfaculty';
        return view('isept.admindekanat.eptfaculty')->with([
      			'homepage'         => $homepage,
    ...
    public function pdf(Request $req){
      ...
      if (($req->ept_date_start == "" && $req->ept_date_end == "") || $req->ept_score == "") {
        return redirect()->route('admindekanat.eptfaculty')->with('error', 'Date Range, dan Range Skor wajib diisi');
      }
      ...
      $pdf = PDFBarry::loadView("isept.admindekanat.pdffaculty", [
        'ept_s1'          => json_encode($ept_s1, JSON_NUMERIC_CHECK),
        'ept_s1_raw'      => $ept_s1,
        'ept_s2'          => json_encode($ept_s2, JSON_NUMERIC_CHECK),
        'ept_s2_raw'      => $ept_s2,
    ...
    public function pdf_university(Request $req){
      ...
      $pdf = PDFBarry::loadView("isept.admindekanat.pdfuniversity", [
        'ept_s1'              => json_encode($ept_s1, JSON_NUMERIC_CHECK),
        'ept_s1_raw'          => $ept_s1,
        'ept_s2'              => json_encode($ept_s2, JSON_NUMERIC_CHECK),
        'ept_s2_raw'          => $ept_s2,
