...
class EptdepartmentController extends Controller
{
  public function index(){
        ...
        return view('isept.eptvaluemanager.eptdepartment')->with([
      			'homepage'         => $homepage,
  ...
  public function pdf(Request $req){
    ...
    // return view('isept.eptvaluemanager.pdfdepartment')->with([
    //   'ept_s1_raw'        => $ept_s1,
    //   'ept_s1'            => json_encode($ept_s1, JSON_NUMERIC_CHECK),
    //   'batch'             => $data,
    //   'jumlah_batch'      => count($data),
    //   'ket'        => $ket
    // ]);
    $pdf = PDFBarry::loadView("isept.eptvaluemanager.pdfdepartment", [
      'ept_s1_raw'        => $ept_s1,
      'ept_s1'            => json_encode($ept_s1, JSON_NUMERIC_CHECK),
      'batch'             => $data,
      'jumlah_batch'      => count($data),
