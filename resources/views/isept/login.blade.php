...
<div class="wrapper-page">
    ...
    <div class="panel panel-color panel-inverse">
        <div class="panel-heading" align="middle">
           ...
           <h3 class="text-center m-t-10"> Sign In to <strong>ISEPT</strong> </h3>
        </div>
            ...
            <form class="form-horizontal m-t-10 p-20 p-b-0" method="POST" action="{{ url('/login') }}">
              {{ csrf_field() }}
                ...
                <div class="form-group m-t-30">
                    <div class="col-sm-7">
                        <a href="{{ url('isept/forgotpassword') }}"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                    </div>
                    <div class="col-sm-5 text-right">
                        <a href="{{ url('isept/signup') }}">Sign Up</a>
                    </div>
                </div>
            </form>
        </div>
