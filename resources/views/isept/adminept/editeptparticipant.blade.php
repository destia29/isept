...
@section('title')
  ISEPT Unila | Edit EPT Participant
@endsection
@section('navbarisept')
          ...
          <div class="panel panel-default">
            <div class="panel-body">
              <div class="panel-heading"><h3 class="panel-title">Edit EPT Participant Form</h3></div>
                <div class="col-sm-6">
                    <form method="POST" action="{{ route('adminept.eptparticipant.edit.post') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="id_reg" value="{{ $edit->id }}">
                    <input type="hidden" name="statusreg" value="{{ $edit->status }}">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <select class="form-control" name="status">
                                      ...
                                      <option value="Unverified" selected>{{ $edit->status }}</option>
                                      <option value="Abandoned">Abandoned</option>
                                      @elseif($edit->status == "Abandoned")
                                      <option value="Abandoned" selected>{{ $edit->status }}</option>
                                      <option value="Unverified">Unverified</option>
                                      @elseif($edit->status == "Verified")
