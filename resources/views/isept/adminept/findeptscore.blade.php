    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="{{ route('adminept.findscore.selectdate') }}" method="GET">
                    {{ csrf_field() }}
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="{{ route('adminept.findscore.selectcustomdate') }}" method="GET">
     ...
     <center>
        <h2><br>OR</h2><br>
        <a href="{{route('adminept.alleptscore')}}"><button type="button" class="btn btn-pink" name="type_file">See All EPT Score</button></a>
     </center>
</div>
