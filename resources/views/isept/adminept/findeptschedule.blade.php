...
<div class="wraper container-fluid">
    <div class="page-title">
        <h3 class="title">Find EPT Schedule</h3>
    </div>
    @if (count($errors) > 0)
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="{{ route('adminept.findschedule.selectdate') }}" method="GET">
                    {{ csrf_field() }}
                    <address class="ngscope"><strong>How to find EPT Schedule Selected Date.</strong></p>
                        1. First you need to select <strong> EPT Type</strong> and <strong>EPT Date</strong>.<br>
                        2. Use <span class="label label-primary" data-toggle="tooltip" data-placement="left">Find EPT Schedule</span> button to search the data.
                      <br><br>
                    <div class="row">
                      <div class="col-md-8">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="{{ route('adminept.findschedule.selectcustomdate') }}" method="GET">
                    <address class="ngscope"><strong>How to find EPT Schedule Custom Date.</strong></p>
                        1. First you need to select <strong> EPT Type</strong> and <strong>EPT Date</strong>.<br>
     ...
     <center>
        <h2><br>OR</h2><br>
        <a href="{{ url('isept/adminept/alleptschedule') }}"><button type="button" class="btn btn-pink" name="type_file">See All EPT Schedule</button></a>
     </center>1
</div>
