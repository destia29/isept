    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="portlet"><!-- /primary heading -->
                ...
                <div id="portlet1" class="panel-collapse collapse in">
                    <div class="portlet-body">
                        <!-- ELEMENT UNTUK MENAMPILKAN MORRIS BAR SECARA DINAMIS  -->
                        ...
                        <?php if (isset($raw_filter)) : ?>
                            <br>
                            <a href="{{ route('admindekanat.eptdepartment.pdf', [
          ...
          <div class="col-lg-12">
            ...
            <div class="portlet-body">
              ...
              <p>
                ...
                4. Results will only show the majors charts from  relevant faculty <br>
                5. If the charts does not appear,
                there is no score value on that date, or the selected date is invalid <br>
                6. Download <b>PDF Chart Report</b> to see more details about it when filter has been activated <br>


              <br><br>
              <p><strong>Choose Faculty, Score Range, and Date</strong></p>
              <div class="row text-center m-t-50 m-b-10">
                <form action="{{ route('admindekanat.eptdepartment.selectfaculty') }}" method="GET">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
