    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="{{ route('eptvaluemanager.eptscorelist.export') }}" method="POST">
                    {{ csrf_field() }}
                    <address class="ngscope"><strong>How to export EPT Score.</strong></p>
                        1. First you need to select <strong> EPT Type</strong> and <strong>EPT Date</strong>.<br>
                        2. Use <span class="label label-primary" data-toggle="tooltip" data-placement="left" title="This is Design">Export EPT Score</span> button to download the data and format of file import.<br>
                        3. You can change participant's EPT score by using this exported file.<br>
                        ...
                        <p><strong>Export EPT Score Here.</strong></p>
                          <div class="btn-group m-b-10">
                            <div class="btn-group dropdown">
                                <button type="submit" class="btn btn-primary" name="type_file" value="csv">Export EPT Score</button>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <address class="ngscope"><strong>How to import EPT Score.</strong></p>
                        1. You can update Participant's EPT Score by importing the exported file.<br>
                        2. The File Import must be <mark>*.csv</mark> extension and <strong>the format must be same as file which has been Exported</strong>.<br>
                        3. You can import the updated EPT Score by using  <span class="label label-success" data-toggle="tooltip" data-placement="left" title="This is Design">Import EPT Score</span>
                      <br><br>
                  <div class="row">
                      <div class="col-md-10">
                      <p><strong>Import EPT Score Here.</strong></p>
                        <form action="{{ route('eptvaluemanager.eptscorelist.import') }}" method="POST" enctype="multipart/form-data">
                          <div class="btn-group m-b-10">
                              {{ csrf_field() }}
                              <input class="btn btn-default" type="file" name="file_import">
                              <button type="submit" class="btn btn-success">Import EPT Score</button>
                          </div>
                        </form>
                      </div>
                  </div>
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                      ...
                                      @foreach($eptscorelist as $data)
                                        ...
                                        <td class="actions">
                                            <a href="{{ route('eptvaluemanager.eptscorelist.edit', ['id' => $data->score_id]) }}" class="btn btn-warning btn-xs btn-flat"><i class="fa fa-pencil"></i></a>
                                            <a href="{{ route('eptvaluemanager.eptscorelist.refresh', $data->score_id) }}" class="btn btn-danger btn-xs btn-flat refresh"><i class="fa fa-refresh"></i></a>
                                        </td>
                                        <td align="center">
                                            @if($data->score_takecourse == "Yes")
                                                <p style="color:green">Yes</p>
                                            @else
                                                <p style="color:red">No</p>
                                                <a href="{{ route('eptvaluemanager.eptscorelist.takecourse', $data->score_id) }}" class="btn btn-infor btn-xs btn-flat success">
                                            <button type="button" class="btn btn-block btn-info btn-xs m-b-5">Yes</button></a>
                                            @endif
                                        </td>
      								                </tr>
                                      @endforeach
