    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">Edit Event Form</h3></div>
                <div class="panel-body">
                    <form class="form-horizontal p-20" role="form" action="{{ route('adminlcu.lcuevent.edit.post') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id_event" value="{{ $edit->id }}">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Event Thumbnail<br>(*max.1mb)</label>
                              <div class="col-md-7">
                                    <input type="hidden" name="event_picture_name" value="{{ $edit->thumbnail }}">

                                    <img src="{{ route('image_event', $edit->thumbnail) }}" class="media-object thumb-xlg" height="180px" width="270px">

                                    <input type="file" class="btn btn-default" name="event_thumbnail">
                              </div>
                        </div>
                        <div class="form-group">
