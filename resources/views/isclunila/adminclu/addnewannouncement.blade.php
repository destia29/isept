...
@section('title')
  ISLCUnila | Add New LCU Announcement
@endsection
...
<div class="wraper container-fluid">
    <div class="page-title">
        <h3 class="title">Add New Announcement</h3>
    </div>
    @if (count($errors) > 0)
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">Add New Announcement Form</h3></div>
                <div class="panel-body">
                    <form class="form-horizontal p-20" role="form" action="{{ route('announcement.add') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Announcement Thumbnail<br>(*max.1mb)</label>
                              <div class="col-md-7">
                                  <input type="file" name="announcement_thumbnail" id="fileToUpload" class="btn btn-default">
                              </div>
                        </div>
                        <div class="form-group">
