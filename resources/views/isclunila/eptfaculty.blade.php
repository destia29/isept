                        ...
                        <?php endif ?>
                          ...
                          <?php if($is_chief == 1): ?>
                              <?php if (isset($raw_filter)) : ?>
                                ...
                                <a href="{{ route('islcunila.chiefoftheboard.eptfaculty.pdf', [
          ...
          <div class="col-lg-12">
            ...
            <div class="portlet-body">
              ...
              <div class="row text-center m-t-50 m-b-10">
                <?php if ($is_chief == 0): ?>
                  <form action="{{ route('isclunila.adminlcu.eptfaculty.filter') }}" method="GET">
                <?php elseif($is_chief == 1): ?>
                  <form action="{{ route('islcunila.chiefoftheboard.eptfaculty.filter') }}" method="GET">
                <?php endif ?>
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-8">
...
$('.monthlyRegistereds2').sparkline(monthlyRegistereds2, {
  ...
  if (epttype == "" || epttype == 1 || is_chief == 0) {
    Morris.Bar({
        element: 's1_ept',
        data: {!! $ept_s1 !!},
        xkey: 'y',
  ...
  if (epttype == "" || epttype == 2 || is_chief == 0) {
    Morris.Bar({
        element: 's2_ept',
        data: {!! $ept_s2 !!},
        xkey: 'y',
