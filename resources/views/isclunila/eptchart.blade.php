...
<?php
    $is_chief = 1;
    if(Auth::user()->role->role_name == "Admin LC Unila"){ $is_chief = 0; }
    // dd($is_chief);
?>
          ...
          <div class="portlet"><!-- /primary heading -->
            <div class="portlet-heading">
                <h3 class="portlet-title text-dark text-uppercase">
                    EPT Participant Report - University Level
                    <?php if (isset($ket)): ?>
                        <?php if ($ket["date"] != ""): ?>
                          <br> Date {{ $ket["date"] }}
                        <?php endif ?>
            ...
            <div id="portlet1" class="panel-collapse collapse in">
                <div class="portlet-body">
                  <h4>D3 / S1</h4>
                  <div id="morris-bar-s1" style="height: 280px;"></div>
                  <h4>Post Graduate/Public</h4>
                  <div id="morris-bar-s2" style="height: 280px;"></div>


                  <?php if($is_chief == 1): ?>
                    <?php if ($raw_filter['date_start'] != "" && $raw_filter['date_end'] != "" && $raw_filter["searchscore_data"] != ""): ?>
                      <a href="{{ route('islcunila.chiefoftheboard.eptchart.pdf', [
              ...
              <div class="col-lg-12">
                ...
                <div class="portlet-body">
                  ...
                  <div class="row text-center m-t-50 m-b-10">
                      <?php if ($is_chief == 0): ?>
                        <form action="{{ route('isclunila.adminlcu.eptchart.filterdata') }}" method="GET">
                      <?php elseif($is_chief == 1): ?>
                        <form action="{{ route('islcunila.chiefoftheboard.eptchart.filterdata') }}" method="GET">
                      <?php endif ?>
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-8">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="input-group">
                                                                      <input type="text" autocomplete="off" name="ept_date_start" class="form-control" placeholder="Start Date" id="datepicker" required="">
                                                                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="input-group">
                                                                      <input type="text" autocomplete="off" name="ept_date_end" class="form-control" placeholder="End Date" id="datepicker2" required="">
                                                                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                            </div>
