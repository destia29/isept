...
<div class="wraper container-fluid">
    <div class="page-title">
        <h3 class="title">Find EPT Score</h3>
    </div>
    @if (count($errors) > 0)
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="{{ route('chiefoftheboard.findscore.selectdate') }}" method="GET">
                    {{ csrf_field() }}
                    <address class="ngscope"><strong>How to find EPT Score Selected Date.</strong></p>
                        1. First you need to select <strong> EPT Type</strong> and <strong>EPT Date</strong>.<br>
                        2. Use <span class="label label-primary" data-toggle="tooltip" data-placement="left">Find EPT Score</span> button to search the data.
                      <br><br>
                    <div class="row">
                      <div class="col-md-8">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="btn-group m-b-10">
                          <div class="btn-group dropdown">
                              <button type="submit" class="btn btn-primary" name="type_file">Find EPT Score</button>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="{{ route('chiefoftheboard.findscore.selectcustomdate') }}" method="GET">
                    <address class="ngscope"><strong>How to find EPT Score Custom Date.</strong></p>
                        1. First you need to select <strong> EPT Type</strong> and <strong>EPT Date</strong>.<br>
     ...
     <center>
        <h2><br>OR</h2><br>
        <a href="{{route('chiefoftheboard.alleptscore')}}"><button type="button" class="btn btn-pink" name="type_file">See All EPT Score</button></a>
     </center>1
</div>
