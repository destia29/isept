...
<div class="wraper container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="portlet"><!-- /primary heading -->
                <div class="portlet-heading">
                  <!-- ICHSAN : INI DIBUAT UNTUK PERULANGAN JAVASCRIPT MORRIS BAR -->
                    ...
                    <div class="portlet-body">
                      ...
                      <?php if($is_chief == 1): ?>
                          <?php if (isset($raw_filter)) : ?>
                            <a href="{{ route('islcunila.chiefoftheboard.eptdepartment.pdf', [
          ...
          <div class="col-lg-12">
            ...
            <div class="portlet-body">
              ...
              <p>
                ...
                <?php if($is_chief == 1): ?>
                5. Download <b>PDF Chart Report</b> to see more details about it when filter has been activated <br>
                <?php endif  ?>
              ...
              <div class="row text-center m-t-50 m-b-10">
                <?php if ($is_chief == 0): ?>
                    <form action="{{ route('isclunila.adminlcu.eptdepartment.selectfaculty') }}" method="GET">
                <?php elseif($is_chief == 1): ?>
                    <form action="{{ route('islcunila.chiefoftheboard.eptdepartment.selectfaculty') }}" method="GET">
                <?php endif ?>
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-8">
