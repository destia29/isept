...
<div class="space60"></div>
  <div class="clearfix prevnext">
    ...
    @else
    <a href="{{ route('announcement.detail', ['id' => $prevdetail->id]) }}" class="left"><i class="fa fa-angle-left"></i>&nbsp;Prev post</a>
    @endif
    @if($nextdetail != NULL)
    <a href="{{ route('announcement.detail', ['id' => $nextdetail->id]) }}" class="right">Next post&nbsp;<i class="fa fa-angle-right"></i></a>
    @else
