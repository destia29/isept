...
<head>
        ...
        <link rel="shortcut icon" href="{{ asset ('images/basic/logounila.png') }}">

      	<title>@yield('title', 'ISCLUnila')</title>
        ...
        <!--bootstrap-wysihtml5-->
        <link rel="stylesheet" type="text/css" href="{{ asset ('assets/isept/bootstrap-wysihtml5/bootstrap-wysihtml5.css') }}" />
        <link href="{{ asset ('assets/isept/summernote/summernote.css') }}" rel="stylesheet" />
    ...
    <body>
		...
		<!-- End Google Tag Manager (noscript) -->
          ...
          @yield('navbarisclunila')
          @include('isclunila/headerisclunila')
          @yield('mainisclunila')
        ...
        <script type="text/javascript" src="{{ asset ('assets/isept/bootstrap-wysihtml5/wysihtml5-0.3.0.js') }}"></script>
        <script type="text/javascript" src="{{ asset ('assets/isept/bootstrap-wysihtml5/bootstrap-wysihtml5.js') }}"></script>
        ...
        <script src="{{ asset ('assets/isept/summernote/summernote.min.js') }}"></script>
        ...
        e.preventDefault();
        swal({  title: "Are you sure?",
            text: "This account will be suspended until you reactivate it!",
            type: "warning",
            showCancelButton: true,
            confirmButtonClass: "btn btn-info btn-fill",
